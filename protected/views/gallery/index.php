    ...
    <header>
        <div class="row lilita tagLn">
            <div class="col-md-12 text-center"><img
                    src="<?php echo Yii::app()->request->baseUrl; ?>/images/fnIcn1.png"/>Get more votes, get more likes
            </div>
        </div>
        <div class="container ">
            <div class="row">
                <div class="col-md-12" style=" color:#fff;">
                    ...
                    <div class="row topVdesHdr topVdesHdrDtdln lilita">
                        <div class="col-md-7">
                            <div class="row">
                                <div class="col-md-4">Gallery<span class="SmlTxt">(<span
                                            id="selectcategory"><?php echo $selectedcategory; ?></span>&nbsp;&nbsp;<span
                                            id="categorycount"><?php echo $totalvideos; ?></span>)</span></div>
                                <div class="col-md-3">
                        ...
                        <div class="col-md-3 text-right pull-right topVdescnt">
                            <input type="text" class="GlrySlct GlrySInpct searchVideos" placeholder="Search Videos"/>
                        </div>
                    </div>
