...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		<?php echo $form->labelEx($model,'google_displayname'); ?>
		<?php echo $form->textField($model,'google_displayname',array('size'=>60,'maxlength'=>100)); ?>
		<?php echo $form->error($model,'google_displayname'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'google_profile_url'); ?>
		<?php echo $form->textField($model,'google_profile_url',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'google_profile_url'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'google_profilepicture'); ?>
		<?php echo $form->textField($model,'google_profilepicture',array('size'=>60,'maxlength'=>255)); ?>
		<?php echo $form->error($model,'google_profilepicture'); ?>
	</div>
